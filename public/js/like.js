...
var handleLike = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            _context.prev = 10;
            _context.next = 13;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().post("/".concat(target, "/").concat(group_id, "/").concat(user_id), {}, {
              headers: {
  ...
  return function handleLike(_x, _x2, _x3) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            control = e.dataset.control; //  外部とのやり取り

            _context2.next = 3;
            return handleLike(control, group_id, user_id);
